...
import com.olamachia.simpleblogapp.util.NewsApplication
...
class NewsViewModel(
    ...
    var webViewUrl = ""
    lateinit var webArticle : Article
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String){
        ...
        try {
            if (hasInternetConnection()){
                ...
                searchNews.postValue(Resource.Error("Check your internet connection"))
            }
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if (hasInternetConnection()){
                ...
                breakingNews.postValue(Resource.Error("Check your internet connection"))
            }
